...
solve8A_2017::IO ()
solve8A_2017 = do
  inCipherText <- readFile "./src/2017/8A.txt"
  let cipherText  = clean isAlpha $ concat $ lines inCipherText

  let pt = reverse $ snd $ solveVig cipherText
  putStrLn $ "8A: pt = " ++ show pt

{-
I ASSUME THAT YOU HAVE LEFT NIJMEGEN WITH THE REAL FINAL CHAPTER OF TACITUSS LAST WORK TO RETURN TO
NORMALITY IN LONDON AS WE AGREED IT WOULD BE BEST TO KEEP ITS DISCOVERY SECRET UNTIL THE COLLECTOR
HAS BEEN GIVEN THE FAKE BY MIDAS I WANT TO THANK YOU WITH ALL MY HEART FOR YOUR HELP WITH BREAKING
THE MIDAS SYNDICATE THE PLAN TO REPLACE THE FINAL CHAPTER OF TACITUSS BOOK WITH A FORGERY WOULD NOT
...
YOU FOR NOW IN CASE YOUR OTHERWISE SPOTLESS RECORD CONCEALS A SECOND SECRET CAREER FOR MYSELF I THINK
THAT IF YOU WOULD BE INTERESTED THEN MY AGENCY COULD USE YOUR SKILLS ONCE WE ARE SURE THAT THE COLLECTOR
HAS TAKEN CUSTODY OF THE FAKE YOU CAN ANNOUNCE THE REAL DOCUMENT AT THE BRITISH LIBRARY AND WE WILL
RELEASE A TRANSLATION OF IT HIGHLIGHTING OUR SECRET MESSAGE ON THE DARK WEB WHEN THE COLLECTOR SEES
THAT I SUSPECT THAT THE REVENGE ON MIDAS WILL BE SWIFT AND MERCILESS WE WILL BE WATCHING AND WITH
LUCK WE WILL ALSO DISCOVER THE IDENTITY OF THE COLLECTOR I THINK THERE MAY BE GREAT PROFIT IN
MONITORING HIS OR HER CONNECTIONS IN ORDER TO GIVE THE DOCUMENT SOME EXTRA VALIDITY WE HAVE ENCRYPTED
IT USING THE HARDEST OF THE IMPERIAL CIPHERS THAT WAY ONLY THE COLLECTOR IS LIKELY TO BE ABLE TO READ
IT MEANWHILE IT IS OF UTMOST IMPORTANCE THAT WE KEEP YOU SAFE THE COLLECTOR DOES NOT KNOW OF YOUR
INVOLVEMENT IN OUR PLAN AND THERE IS NO REASON WHY THAT SHOULD CHANGE I WOULD RECOMMEND THAT YOU
RETURN TO YOUR WORK AT THE BRITISH LIBRARY FOR NOW THEY WILL BE DELIGHTED TO RECEIVE THE ORIGINAL
COPY OF TACITUSS FINAL WORK AS I SAID BEFORE HARRYS TEAM WILL BE WATCHING YOU AND THAT SHOULD BE
ENOUGH TO ENSURE YOUR SAFETY IT HAS BEEN A GREAT PLEASURE AND PRIVILEGE TO WORK WITH YOU I HOPE
WE HAVE THE OPPORTUNITY TO WORK TOGETHER AGAIN MARYAM
-}
